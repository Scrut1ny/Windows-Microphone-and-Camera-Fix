...
cls&echo(&echo   All camera ^& microphone access [32mallowed[0m.&>nul pause&goto :MENU
exit /b
...
cls&echo(&echo   All camera ^& microphone access [31mdenied[0m.&>nul pause&goto :MENU
exit /b 0
