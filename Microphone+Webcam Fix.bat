...
>nul 2>&1(
	...
	reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy" /v "LetAppsAccessCamera" /d "1" /t REG_SZ /f
	...
	rem Using GPO (re-activation through GUI is not possible)
	reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy" /v "LetAppsAccessMicrophone" /d "1" /t REG_SZ /f
